...
('bezúhonný', 'B', 'férový,korektný,morálny,mravný,poctivý,počestný,seriózny,slušný,vzorný,vážený,čestný'),
...
('drobný', 'B', 'drobunký,malinký,maličký,malý,miniatúrny,nepatrný,filigránsky,útly,subtílny,šťúply,šťúplušký,liliputánsky,mikroskopický,myšací,drobčivý,drobnulinký,drobulinký,drobušký,drobučký,drobnuľký,drobnušký,zakrpatený,krpatý'),
...
('hypotetický', 'B', 'domnelý,fiktívny,imaginárny,neskutočný,pomyselný,predpokladaný,predstieraný,vymyslený,zdanlivý,údajný,teoretický'),
...
('nemý', 'B', 'mlčanlivý,nehlučný,tichý,mĺkvy,bezslovný,zamĺknutý,onemený'),
('nenápadný', 'A', 'nevtieravý,všedný,nevýrazný,kradmý,utajený,jednoduchý,jemný,diskrétny'),
('neoblomný', 'A', 'nepoddajný,nepodkupný,nezlomný,neúprosný,neústupný,neústupčivý,tvrdohlavý,húževnatý,vytrvalý'),
...
('podobný', 'A', 'analogický,korešpondujúci,obdobný,príbuzný,blízky,spriaznený,spríbuznený,podaný,podatý,rovnaký,zhodný,porovnateľný'),
...
('pravý', 'A', 'faktický,hmatateľný,konkrétny,naozajstný,nefalšovaný,poctivý,pravdivý,rýdzi,skutočný,čistý,autentický,hodnoverný,originálny,pôvodný,ozajstný,opravdivý,nepredstieraný,plnokrvný,číry,stopercentný'),
